...
CameraFactory::generateCameraFromYamlFile(const std::string& filename)
{
    ...
    if (!fs["model_type"].isNone())
    {
        ...
        if (camodocal::iequals(sModelType, "kannala_brandt"))
        {
            modelType = Camera::KANNALA_BRANDT;
        }
        else if (camodocal::iequals(sModelType, "mei"))
        {
            modelType = Camera::MEI;
        }
        else if (camodocal::iequals(sModelType, "scaramuzza"))
        {
            modelType = Camera::SCARAMUZZA;
        }
        else if (camodocal::iequals(sModelType, "pinhole"))
        {
