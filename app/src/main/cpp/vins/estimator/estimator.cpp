...
bool Estimator::relativePose(Matrix3d &relative_R, Vector3d &relative_T, int &l)
{
    ...
    for (int i = 0; i < WINDOW_SIZE; i++)
    {
        ...
        if (corres.size() > 20)
        {
            ...
            if(average_parallax * 460 > 15 && m_estimator.solveRelativeRT(corres, relative_R, relative_T))
            {
                l = i;
...
void Estimator::optimization()
{
    ...
    for (int i = 0; i < WINDOW_SIZE + 1; i++)
    {
        ceres::Manifold *local_manifold = new PoseLocalParameterization();
        problem.AddParameterBlock(para_Pose[i], SIZE_POSE);
        problem.SetManifold(para_Pose[i], local_manifold);
    ...
    for (int i = 0; i < NUM_OF_CAM; i++)
    {
        ...
        problem.SetManifold(para_Ex_Pose[i], local_manifold);
    ...
    if(relocalization_info)
    {
        ...
        problem.SetManifold(relo_Pose, local_manifold);
